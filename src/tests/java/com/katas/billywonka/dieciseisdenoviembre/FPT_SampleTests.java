...
public class FPT_SampleTests {
	...
	@Test
	public void fixedTests00() {
		assert fixed_solutions.size() == fixed_tests.length;
		Preloaded.verify(fixed_tests[0], fixed_solutions.get(0));
	}
	@Test
	public void fixedTests01() {
		assert fixed_solutions.size() == fixed_tests.length;
		Preloaded.verify(fixed_tests[1], fixed_solutions.get(1));
	}
	@Test
	public void fixedTests02() {
		assert fixed_solutions.size() == fixed_tests.length;
		Preloaded.verify(fixed_tests[2], fixed_solutions.get(2));
	}
	@Test
	public void fixedTests03() {
		assert fixed_solutions.size() == fixed_tests.length;
		Preloaded.verify(fixed_tests[3], fixed_solutions.get(3));
	}
	@Test
	public void fixedTests04() {
		assert fixed_solutions.size() == fixed_tests.length;
		Preloaded.verify(fixed_tests[4], fixed_solutions.get(4));
	}
}